package com.github.FelipeAlafy.adjustingbase.modTools.armor;
...
public enum ModArmorMaterial implements IArmorMaterial {
    //Types
    RUBY(AdjustingBase.MOD_ID + ":ruby", 25, new int[] { 2, 5, 6, 2 }, 18,
    ...
    //knockbackResistence value has added in 1.16 because Netherite Armor
    /*@Override
