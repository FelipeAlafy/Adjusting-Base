...
import com.github.FelipeAlafy.adjustingbase.modTools.armor.ModArmorMaterial;
...
import com.github.FelipeAlafy.adjustingbase.modTools.tools.ModItemTier;
...
public class RegistryHandler {
    ...
    public static final RegistryObject<HoeItem> RUBY_HOE = ITEMS.register("ruby_hoe", () ->
            new HoeItem(ModItemTier.RUBY, -3,  new Item.Properties().group(AdjustingBase.TAB)));
    ...
    //Blocks
    public static final RegistryObject<Block> RUBY_BLOCK = BLOCKS.register("ruby_block", com.github.FelipeAlafy.adjustingbase.blocks.RubyBlock::new);
